      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-green-800 dark:text-green-200">Shopping Lists</h1>
              <p className="text-green-600 dark:text-green-400">Manage your shopping lists and items</p>
            </div>
          </div>
