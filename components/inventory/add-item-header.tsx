    ...
    <header className="border-b border-green-200 dark:border-green-800 bg-white/80 dark:bg-green-950/80 backdrop-blur-sm">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-green-800 dark:text-green-200">Add Food Item</h1>
            <p className="text-green-600 dark:text-green-400">Add a new item to your pantry</p>
          </div>
        </div>
      </div>
    </header>
